<template>
  <div class="home container">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-3" v-for="contact in searchContact" :key="contact.id" @click="$router.push({name: 'single', params: {id: contact.id}})" v-bind:test="'work'">
        <div class="shadow d-flex align-items-center pl-2 py-1">
          <div class="avatar">
